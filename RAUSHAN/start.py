...
async def start(bot: Client, msg: Message):
    ...
    await bot.send_photo(
        chat_id=msg.chat.id,
        photo="https://files.catbox.moe/azvurg.jpg",
...
✦ » ɪғ ʏᴏᴜ ɴᴇᴇᴅ ᴀɴʏ ʜᴇʟᴘ, ᴛʜᴇɴ ᴅᴍ ᴛᴏ ᴍʏ ᴏᴡɴᴇʀ: [⌯꯭ 𝐬͟ ꯭⋏꯭ ꯭𝖎 ꯭ ꯭ᴍ͟🥂꯭ 𝗫꯭ ꯭ᴅ ꯭꯭-//꯭- ִֶָ ꯭꯭꯭݁🥀꯭](tg://user?id={OWNER_ID}) !""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("🔸 sᴜᴘᴘᴏʀᴛ🔸", url="https://t.me/xyz_own_world"),
                    InlineKeyboardButton("▫️ ᴜᴘᴅᴀᴛᴇs▫️", url="https://t.me/SAIM_WORLD")
                ],
                [
